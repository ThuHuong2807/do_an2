...
<!-- /.col-lg-12 -->
  ...
  <form method = "post" enctype="multipart/form-data" action="{{ url('admin/giao_vien/import') }}">
            {{csrf_field()}}
...
<div class="col-lg-7" style="padding-bottom:120px">
    ...
    <form action="admin/giao_vien/view_insert" method="POST">
    	<input type="hidden" name="_token" value="{{csrf_token()}}" />
           <div class="form-group">
            <label>Name teacher</label>
            <input class="form-control" name="ten_giao_vien" placeholder="Please Enter teacher name" />
        </div>
        <div class="form-group">
