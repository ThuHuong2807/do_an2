        ...
        <div class="row">
            ...
            <!-- /.col-lg-12 -->
              <div class="col-lg-7" style="padding-bottom:120px">
                ...
                @endif
                <form action="admin/giao_vu/view_update/{{$giao_vu->ma_giao_vu}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <td>
                            ...
                            <input type="radio" name="gioi_tinh" value="1" @if ($giao_vu->gioi_tinh==1) checked @endif>Female</td>
                    </div>
                     <div class="form-group">
                        <label>Email</label>
