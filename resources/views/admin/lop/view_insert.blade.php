...
<div class="container-fluid">
    <div class="row">
        ...
        <!-- /.col-lg-12 -->
          ...
          <form method = "post" enctype="multipart/form-data" action="{{ url('admin/lop/import') }}">
            {{csrf_field()}}
        ...
        <div class="col-lg-7" style="padding-bottom:120px">
            ...
            <form action="admin/lop/view_insert" method="POST">
            	<input type="hidden" name="_token" value="{{csrf_token()}}" />
                   <div class="form-group">
                    <label>Name</label>
                    <input class="form-control" name="ten_lop" placeholder="Please Enter class name" />
                </div>
